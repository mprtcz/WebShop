...
<center>
    ...
    <div class="container-fluid">
        ...
        <div class="btn-group-vertical">
            ...
            <a href="/itemslist" type="submit" class="btn btn-primary" value="Items List">Go to the items list</a></p>
            <sec:authorize access="hasRole('ADMIN') or hasRole('CUSTOMER')">
                <a href="/userslist" type="submit" class="btn btn-primary" value="Users List">Go to the list of
                    users</a></p>
            </sec:authorize>
        </div>
    </div>
